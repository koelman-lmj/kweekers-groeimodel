...
export const optionSets: OptionSetDefinition[] = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "value": "1-25",
        "label": "1–25 medewerkers",
        "order": 10
      },
      {
        "value": "26-100",
        "label": "26–100 medewerkers",
        "order": 20
      },
      {
        "value": "101-250",
        "label": "101–250 medewerkers",
        "order": 30
      },
      {
        "value": "251-500",
        "label": "251–500 medewerkers",
        "order": 40
      },
      {
        "value": "500+",
        "label": "500+ medewerkers",
        "order": 50
      }
    ]
  },
  {
    ...
    "options": [
      ...
      {
        "value": "1",
        "label": "1 administratie",
        "order": 10
      },
      {
        "value": "2-3",
        "label": "2–3 administraties",
        "order": 20
      },
      {
        "value": "4-10",
        "label": "4–10 administraties",
        "order": 30
      },
      {
        "value": "10+",
        "label": "10+ administraties",
        "order": 40
      }
    ]
  },
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Functioneel beheer en wijzigingen liggen vooral bij een externe partner.",
        "order": 10
      },
      {
        "value": "een_beheerder",
        "label": "1 beheerder",
        "description": "Er is één persoon die AFAS en procesbeheer grotendeels trekt.",
        "order": 20
      },
      {
        "value": "centraal_beheerteam",
        "label": "Beheerdersteam (centraal geregeld)",
        "description": "Beheer is centraal georganiseerd in een vast team of centrale beheerfunctie.",
        "order": 30
      },
      {
        "value": "decentraal_key_users",
        "label": "Beheer per afdeling (key-users) zonder centraal",
        "description": "Beheer ligt verspreid bij key-users of afdelingen, zonder centrale regie.",
        "order": 40
      },
      {
        "value": "geen_beheer",
        "label": "Geen duidelijke beheerstructuur",
        "description": "Er is geen duidelijke beheerstructuur of vast aanspreekpunt ingericht.",
        "order": 50
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "AFAS is nog relatief recent in gebruik. De inrichting is waarschijnlijk nog jong.",
        "order": 10
      },
      {
        "value": "tussen_2_en_5_jaar",
        "label": "2 tot 5 jaar",
        "description": "AFAS is al enige tijd in gebruik, maar de inrichting is nog niet heel oud.",
        "order": 20
      },
      {
        "value": "tussen_5_en_10_jaar",
        "label": "5 tot 10 jaar",
        "description": "De inrichting heeft al meerdere jaren historie en waarschijnlijk meerdere wijzigingsrondes gehad.",
        "order": 30
      },
      {
        "value": "10_jaar_of_langer",
        "label": "10 jaar of langer",
        "description": "AFAS heeft een lange historie binnen de organisatie. De kans op opgebouwde complexiteit is groter.",
        "order": 40
      },
      {
        "value": "onbekend",
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Beheer, opschoning, documentatie en wijzigingen zijn de afgelopen jaren goed bijgehouden.",
        "order": 10
      },
      {
        "value": "redelijk_onderhouden",
        "label": "Redelijk onderhouden",
        "description": "De basis is bijgehouden, maar niet alles is even strak of structureel onderhouden.",
        "order": 20
      },
      {
        "value": "achterstallig_onderhoud",
        "label": "Achterstallig onderhoud",
        "description": "Er is duidelijk achterstand in beheer, opschoning, documentatie of gecontroleerde wijzigingen.",
        "order": 30
      },
      {
        "value": "moeilijk_te_beoordelen",
        "label": "Moeilijk te beoordelen",
        "description": "Het is op dit moment nog niet goed vast te stellen hoe goed de inrichting is onderhouden.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Er worden naar verwachting organisatieveranderingen voorzien die impact hebben op inrichting of beheer.",
        "order": 10
      },
      {
        "value": "mogelijk",
        "label": "Mogelijk",
        "description": "Er zijn signalen of plannen, maar nog geen harde zekerheid over de impact of timing.",
        "order": 20
      },
      {
        "value": "nee",
        "label": "Nee",
        "description": "Er worden op dit moment geen grote organisatieveranderingen verwacht.",
        "order": 30
      },
      {
        "value": "nog_onbekend",
        "label": "Nog onbekend",
        "description": "Het is nog niet duidelijk of zulke veranderingen gaan spelen.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De inrichting volgt grotendeels de standaard van AFAS, met weinig uitzonderingen.",
        "order": 10
      },
      {
        "value": "standaard_met_beetje_maatwerk",
        "label": "Standaard met een klein beetje maatwerk",
        "description": "De basis is standaard, met enkele aanvullende uitzonderingen of beperkte aanpassingen.",
        "order": 20
      },
      {
        "value": "veel_maatwerk",
        "label": "Veel maatwerk",
        "description": "De inrichting en werkwijze leunen sterk op maatwerk, uitzonderingen of afwijkende oplossingen.",
        "order": 30
      },
      {
        "value": "moeilijk_te_beoordelen",
        "label": "Moeilijk te beoordelen",
        "description": "Het is nu nog niet duidelijk in hoeverre de inrichting standaard of maatwerkgedreven is.",
        "order": 40
      }
    ]
  },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "value": "rapportage",
        "label": "Rapportage & sturing",
        "order": 40
      },
      {
        "value": "groei",
        "label": "Voorbereiding op groei",
        "order": 50
      },
      {
        "value": "overig",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "value": "data_integraties",
        "label": "Data / integraties",
        "order": 50
      },
      {
        "value": "adoptie",
        "label": "Adoptie en gebruik",
        "order": 60
      }
    ]
  },
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De grootste opgave zit in een stabiele en betrouwbare financiële basis.",
        "order": 10
      },
      {
        "value": "uitzonderingen_handwerk",
        "label": "Uitzonderingen en handwerk",
        "description": "De grootste opgave zit in afwijkingen, correcties en handmatige verwerking.",
        "order": 20
      },
      {
        "value": "stuurinformatie",
        "label": "Stuurinformatie en inzicht",
        "description": "De grootste opgave zit in tijdig, betrouwbaar en bruikbaar inzicht.",
        "order": 30
      },
      {
        "value": "meerdere_administraties",
        "label": "Complexiteit door meerdere administraties",
        "description": "De grootste opgave zit in structuur, samenhang of afstemming tussen administraties.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De grootste opgave zit in het consequent vastleggen en opvolgen van commerciële acties.",
        "order": 10
      },
      {
        "value": "pipeline_forecast",
        "label": "Pipeline en forecast",
        "description": "De grootste opgave zit in grip op kansen, voortgang en verwachte omzet.",
        "order": 20
      },
      {
        "value": "relatie_data",
        "label": "Relatie- en contactgegevens",
        "description": "De grootste opgave zit in kwaliteit, volledigheid en actualiteit van CRM-gegevens.",
        "order": 30
      },
      {
        "value": "gebruik_adoptie",
        "label": "Gebruik en adoptie",
        "description": "De grootste opgave zit in structureel gebruik van CRM door de organisatie.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De grootste opgave zit in het goed en eenduidig verwerken van orders.",
        "order": 10
      },
      {
        "value": "blokkades_vrijgave",
        "label": "Blokkades en vrijgave",
        "description": "De grootste opgave zit in controle, vrijgave en uitzonderingen in de orderflow.",
        "order": 20
      },
      {
        "value": "levering_facturatie",
        "label": "Levering en facturatie",
        "description": "De grootste opgave zit in de doorstroming naar levering en factuur.",
        "order": 30
      },
      {
        "value": "afwijkingen_handwerk",
        "label": "Afwijkingen en handwerk",
        "description": "De grootste opgave zit in afwijkende routes, uitzonderingen en handmatige ingrepen.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De grootste opgave zit in het correct en tijdig verwerken van HR-mutaties.",
        "order": 10
      },
      {
        "value": "dossiers_vastlegging",
        "label": "Dossiers en vastlegging",
        "description": "De grootste opgave zit in volledigheid en kwaliteit van HR-dossiers en gegevens.",
        "order": 20
      },
      {
        "value": "proces_uniformiteit",
        "label": "Procesuniformiteit",
        "description": "De grootste opgave zit in eenduidige HR-processen en werkwijzen.",
        "order": 30
      },
      {
        "value": "selfservice_gebruik",
        "label": "Selfservice en gebruik",
        "description": "De grootste opgave zit in gebruik door medewerkers en leidinggevenden.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De grootste opgave zit in eenduidige definities en stuurgetallen.",
        "order": 10
      },
      {
        "value": "betrouwbaarheid_cijfers",
        "label": "Betrouwbaarheid van cijfers",
        "description": "De grootste opgave zit in vertrouwen in de juistheid van rapportages.",
        "order": 20
      },
      {
        "value": "snelheid_actualiteit",
        "label": "Snelheid en actualiteit",
        "description": "De grootste opgave zit in tijdige beschikbaarheid van informatie.",
        "order": 30
      },
      {
        "value": "bruikbaarheid_sturing",
        "label": "Bruikbaarheid voor sturing",
        "description": "De grootste opgave zit in het daadwerkelijk gebruiken van rapportage voor besluitvorming.",
        "order": 40
      }
    ]
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "De grootste opgave zit in uitval, verstoringen en continuïteit van koppelingen.",
        "order": 10
      },
      {
        "value": "eigenaarschap_beheer",
        "label": "Eigenaarschap en beheer",
        "description": "De grootste opgave zit in duidelijke verantwoordelijkheid voor koppelingen en wijzigingen.",
        "order": 20
      },
      {
        "value": "monitoring_opvolging",
        "label": "Monitoring en opvolging",
        "description": "De grootste opgave zit in signalering en opvolging van fouten en verstoringen.",
        "order": 30
      },
      {
        "value": "handmatig_herstel",
        "label": "Handmatig herstel",
        "description": "De grootste opgave zit in afhankelijkheid van handmatige controles of herstelacties.",
        "order": 40
      }
    ]
  }
