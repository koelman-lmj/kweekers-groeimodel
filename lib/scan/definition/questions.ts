...
export const questions: QuestionDefinition[] = [
  ...
  },
  {
    ...
    helpText: "Kies de omschrijving die het best past.",
    inputType: "single_select",
    required: true,
    optionSetKey: "organization_type_options",
    examples: [
      "Bijvoorbeeld: centraal aangestuurd of projectmatig",
      "Of: meerdere teams, locaties of entiteiten",
    ],
  },
  {
    key: "afas_products",
  ...
  },
  {
    ...
    helpText: "Kies wat het best past bij de huidige werkwijze.",
    inputType: "single_select",
    required: true,
    optionSetKey: "standardization_context_options",
    examples: [
      "Meeste werk volgt een vaste standaard",
      "Of er zijn veel uitzonderingen of maatwerk",
    ],
  },
  {
