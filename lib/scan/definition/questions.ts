...
export const questions: QuestionDefinition[] = [
  ...
  },
  {
    ...
    sectionCode: "diagnose",
    order: 65,
    label: "Opvolging van verbeterideeën",
    helpText: "Hoe goed worden verbeterideeën vastgelegd en opgepakt?",
    inputType: "single_select",
    required: true,
    optionSetKey: "maturity_3level_improvement_options",
    allowsComment: true,
    ...
    scoreWeight: 1,
    examples: [
      "Komen goede ideeën in een backlog?",
      "Of verdwijnen ze in de waan van de dag?",
    ],
  },
  {
    key: "learning_from_mistakes",
    sectionCode: "diagnose",
    order: 68,
    label: "Leren van fouten en incidenten",
    helpText: "Hoe goed leert de organisatie van wat misgaat?",
    inputType: "single_select",
    required: true,
    optionSetKey: "maturity_3level_improvement_options",
    allowsComment: true,
    ...
    scoreWeight: 1,
    examples: [
      "Wordt er na een incident geëvalueerd?",
      "Ontstaan er structurele verbeteringen uit?",
    ],
  },
  {
